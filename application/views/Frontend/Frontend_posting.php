                    ...
                    <div class="row">
                        <!--<div class="col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="selectboxWidth" name="noOfDaysToActive" id="noOfDaysToActive" placeholder="No.of days to be displayed on the site..."  required
...
//                }
                ...
                $.ajax({
                    url: baseUrl+"createAdPost",
                    data: fd,
                    contentType: false,
                    processData: false,
                    type: 'POST',
                    success: function(reponse){
                        window.location.replace(baseUrl+"posting");
                    }
                });
            }
        });
