            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        <select id="basic2" name="citySelectBox" class="show-tick form-control" multiple
        ...
        <div class="category-list">
            <div id="parentVerticalTab">
                <span class="active total" style="display:block;" data-toggle="modal" data-target="#myModal"
                      id="selectedcity">(Select your city to see local ads)</span>
                        ...
                        <div>
                            <div class="category">
                                <div class="category-img">
                                    ...
                                    <div class="focus-image"><i class="<?php echo $categoryArray[$i]['icons']; ?>"></i>
                                    </div>
                                </div>
                                ...
                                <div class="category-info">
									...
									<span> <?php $catId = $categoryArray[$i]['categoryId'];
                                        ...
                                        ?> Ads</span>
                                    <a href="<?php echo base_url(); ?>adsList?param=<?php echo $urlparam; ?>">View all
                                        Ads</a>
                                </div>
                                ...
                                <ul>
                                    ...
                                    if (isset($subCategorylist[$catId])) {
                                        ...
                                        for ($j = 0; $j < $counterval; $j++) {
                                            ...
                                            ?>
                                            <li>
                                                <a href="<?php echo base_url(); ?>adsList?param=<?php echo $urlparam; ?>"> <?php echo $subcatInnerList['subCategory'][$j]; ?> </a>
                                            </li>
