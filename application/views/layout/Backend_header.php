...
<head>
    ...
    <meta name="author" content="1stepshop">
    ...
    <link href="<?php echo base_url(); ?>assets/plugins/jquery-circliful/css/jquery.circliful.css" rel="stylesheet"
          type="text/css"/>
...
<header id="topnav">
    <div class="topbar-main">
        <div class="container">
            ...
            <!-- Logo container-->
            <div class="logo">
                <a href="<?php echo base_url(); ?>" class="logo"><i class="md md-equalizer"></i> <span>1StepShop</span> </a>
            </div>
            <!-- End Logo container-->
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle waves-effect waves-light profile" data-toggle="dropdown"
                           aria-expanded="true"><img
                                src="<?php echo base_url(); ?>assets/images/users/defaultprofilelogo.png" alt="user-img"
                                class="img-circle"> </a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url(); ?>Backend/editProfile"><i class="ti-user m-r-5"></i>
                                    Profile</a></li>
                            <!--                            <li><a href="javascript:void(0)"><i class="ti-lock m-r-5"></i> Lock screen</a></li>-->
                            <li><a href="<?php echo base_url(); ?>Backend/logout"><i class="ti-power-off m-r-5"></i>
                                    Logout</a></li>
                        </ul>
                    </li>
                </ul>
